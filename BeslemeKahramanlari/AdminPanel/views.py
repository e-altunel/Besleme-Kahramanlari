...
def feed_points_edit(request, id):
    ...
    if request.method == "POST":
        ...
        if not form.is_valid():
            ...
            return render(
                request,
                "AdminPanel/feed_points_edit.html",
                {"form": form, "feed_point": feed_point},
            )
        ...
        if (
            not form.cleaned_data.get("food_amount")
            and not form.cleaned_data.get("latitude")
            and not form.cleaned_data.get("longitude")
        ):
        ...
        if (
            form.cleaned_data.get("latitude") < -90
            or form.cleaned_data.get("latitude") > 90
        ):
        ...
        if (
            form.cleaned_data.get("longitude") < -180
            or form.cleaned_data.get("longitude") > 180
        ):
